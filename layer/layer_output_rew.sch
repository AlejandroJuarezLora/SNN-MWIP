...
C {devices/ipin.sym} 40 -1940 0 0 {name=p37 lab=Iext0}
C {devices/lab_pin.sym} 980 -2240 2 0 {name=p39 sig_type=std_logic lab=vout0}
C {devices/lab_pin.sym} 960 -1990 1 0 {name=p40 sig_type=std_logic lab=vout1}
C {devices/lab_pin.sym} 960 -1720 0 0 {name=p41 sig_type=std_logic lab=vout2}
C {devices/iopin.sym} 220 -1820 0 0 {name=p43 lab=hx}
C {devices/lab_pin.sym} 740 -2320 1 1 {name=p22 sig_type=std_logic lab=Iext0}
C {devices/lab_pin.sym} 710 -1940 1 1 {name=p28 sig_type=std_logic lab=Iext1}
C {devices/lab_pin.sym} 720 -1640 1 1 {name=p29 sig_type=std_logic lab=Iext2}
C {devices/lab_pin.sym} 700 -1280 1 1 {name=p35 sig_type=std_logic lab=Iext3}
...
C {devices/lab_pin.sym} 990 -1390 0 0 {name=p14 sig_type=std_logic lab=vout3}
C {devices/iopin.sym} 80 -1920 0 0 {name=p9 lab=vout1}
C {devices/iopin.sym} 80 -1890 0 0 {name=p10 lab=vout2}
C {devices/iopin.sym} 80 -1870 0 0 {name=p15 lab=vout3}
C {devices/iopin.sym} 190 -1940 0 0 {name=p8 lab=nvout0}
C {devices/iopin.sym} 190 -1920 0 0 {name=p17 lab=nvout1}
C {devices/iopin.sym} 190 -1900 0 0 {name=p18 lab=nvout2}
C {devices/iopin.sym} 190 -1880 0 0 {name=p20 lab=nvout3}
C {devices/ipin.sym} 40 -1920 0 0 {name=p21 lab=Iext1}
C {devices/ipin.sym} 40 -1900 0 0 {name=p24 lab=Iext2}
C {devices/ipin.sym} 40 -1880 0 0 {name=p25 lab=Iext3}
C {devices/lab_pin.sym} 920 -2310 2 0 {name=p27 sig_type=std_logic lab=nvout0}
