...
C {layer/layer_hidden.sym} 310 550 0 0 {name=x6}
C {Synapse/stdp_8x4.sym} 540 520 0 0 {name=x7}
...
C {/foss/designs/SNN-MWIP/layer/layer_output_rew.sym} 1000 680 0 0 {name=x8}
...
C {/foss/designs/SNN-MWIP/Synapse/no_stdp_4x4x8.sym} 260 590 0 0 {name=x5}
