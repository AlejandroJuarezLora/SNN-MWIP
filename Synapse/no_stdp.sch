...
N 410 -340 450 -340 {lab=te}
N 245 -760 345 -760 {lab=vdd}
N 285 -730 585 -730 {lab=#net1}
N 60 -580 60 -485 {
lab=#net1}
N 60 -455 120 -455 {
lab=vss}
...
N 540 -650 585 -650 {lab=#net1}
N 750 -760 750 -650 {lab=vdd}
N 620 -760 750 -760 {lab=vdd}
N 540 -690 540 -650 {lab=#net1}
N 620 -690 625 -690 {lab=#net2}
N 540 -730 540 -690 {lab=#net1}
N 350 -340 410 -340 {lab=te}
...
C {devices/iopin.sym} 575 -450 0 0 {name=p8 sig_type=std_logic lab=n_vout_post}
C {devices/iopin.sym} -25 -455 0 1 {name=p9 sig_type=std_logic lab=n_vout_pre}
